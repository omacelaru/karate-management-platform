...
import ro.unibuc.fmi.karate_management_platform.models.referee.RefereeCategory;
 ...
 * including the relevant details about the referee's license, category, and user details.
 ...
 */
@Schema(name = "RefereeResponse", description = "DTO representing the response for a referee. It includes necessary information about the referee's license, category, and user details.")
